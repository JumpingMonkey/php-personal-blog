...
<div class="bg-white">
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <form action="/admin/articles" method="POST" class="space-y-8 divide-y divide-gray-200">
            <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                <div class="space-y-6 sm:space-y-5">
                    <div>
                        <h3 class="text-2xl font-semibold leading-6 text-gray-900">Create New Article</h3>
                        <p class="mt-2 max-w-2xl text-sm text-gray-500">
                            Write a new article using Markdown formatting.
                        </p>
                    </div>
